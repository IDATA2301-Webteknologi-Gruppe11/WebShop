...
public class UserController {
    ...
    public ResponseEntity<User> getUserFromId(
            @Parameter(name = "id", description = "the id of the user that you want to find") @PathVariable int id) {
    ...
    /**
     * Adds a user.
     * Also return, https status. OK of it worked, BAD REQUEST if somthing is wrong
     * with the user.
     *
     ...
     * Also return the http status. OK if it worked, NOT FOUND if the id does not
     * exsists and INTERNAL SERVER ERROR if it exists but didnt work.
     *
    ...
    public ResponseEntity<User> updateUser(
            @Parameter(name = "id", description = "id of the user that you want to update") @PathVariable int id,
            @Parameter(name = "user", description = "the user that the exsisting user you want to be updated to") @PathVariable User user) {
    ...
    /**
     * Removes a user.
     * Returns the https status. OK of it worked, INTERNAL SERVER ERROR if it did
     * not work.
     *
