...
//        products.add(new Product("name1", 20, "test1"));
//        products.add(new Product("name2", 21, "test2"));
//    }
//
//    @BeforeEach
...
//    @Test
//    void testFindById() {
//        Product product = new Product("name1", 20, "test1");
...
//        Product product = new Product("", 21, "test3");
...
//    @Test
//    void testDelete() {
//        when(productRepository.findById(1)).thenReturn(Optional.of(new Product("name1", 20, "test1")));
